...
TOTVSLAFAMILIA = tabla1_f.iloc[0]['GRAND TOTAL']
TASAVSLAFAMILIA = tabla1_f.iloc[0]['tasa_acumulada']
       ...
       dbc.Row(
            [
                ...
                html.P(
                   ...
                   " Entre 2015 y 2021 se registraron "+ str(f"{int(TOTVSLAFAMILIA):,}") +" casos, lo que representa una tasa de "+
       str(TASAVSLAFAMILIA) +" delitos por cada 100 mil habitantes. "+
