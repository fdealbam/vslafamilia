...
delitos = pd.read_csv("https://raw.githubusercontent.com/fdealbam/vslafamilia/main/vslafamilial15-21.csv")
    ...
    dbc.Row(
       ...
       dbc.Row(
            [
                ...
                html.P(
                    "En otros delitos contra la familia es "#Aqui cambia nombre de delito
                    ...
                    " relevancia en la agenda seguridad pública del país, también. Este dashboard analítico se compone "
                    " de una sección en la cual tratamos"+
                    "otros delitos contra la familia," #Aqui cambia nombre de delito
                    " observamos su gravedad según intervalos anuales o mensuales; incluimos el análisis detallado de cuatro "
                    "entidades con más incidencias de este delito; finalmente, comparamos los rankings por entidad según "
                    "sumas del periódo 2015 al 2021 con las tasas por entidad del mismo intervalo. Hoy existen cada vez mayor"
